...
sample_id_list = ['jIV_FsBKbW4','DkLpKaVB3IE']
# All of these are new mock data that we'll use
sample_playlist_id = ObjectId('5da79a9dd964b86b120a17ef')
sample_playlist = {
    'title': 'Random Videos',
    'description': 'randomly selected liked videos',
    'videos': [
        'https://youtube.com/embed/jIV_FsBKbW4',
        'https://youtube.com/embed/DkLpKaVB3IE'
    ],
    'video_ids': ['jIV_FsBKbW4','DkLpKaVB3IE']
}
sample_form_data = {
...
class PlaylistsTests(TestCase):
    ...
    def test_video_url_creator(self):
        ...
        expected_list = ['https://youtube.com/embed/jIV_FsBKbW4', 'https://youtube.com/embed/DkLpKaVB3IE']
